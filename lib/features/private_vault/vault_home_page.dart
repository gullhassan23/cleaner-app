...
import 'package:cleaner_app/widgets/private_vault/vault_empty_state.dart';
import 'package:cleaner_app/widgets/private_vault/vault_media_tile.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      return Padding(
        ...
        child: FilledButton(
          onPressed:
              controller.isImporting.value ? null : controller.showImportSheet,
          style: FilledButton.styleFrom(
